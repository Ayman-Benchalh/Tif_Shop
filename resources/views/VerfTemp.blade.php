...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="{{ url('image/shops.png') }}" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 116px;" width="116" class="v-src-width v-src-max-width"/>
      </a>
    </td>
  </tr>
</table>
...
<p style="font-size: 14px; line-height: 190%;">[Name of Reference]</p>
<p style="font-size: 14px; line-height: 190%;">[Title of Reference]</p>
<p style="font-size: 14px; line-height: 190%;">[Reference Company Name] [Address]</p>
<p style="font-size: 14px; line-height: 190%;"> </p>
<p style="font-size: 14px; line-height: 190%; text-align: center;"><span style="font-size: 22px; line-height: 41.8px;"><strong>Regarding: (Candidate's Name)</strong></span></p>
  </div>
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:60px; v-text-anchor:middle; width:371px;" arcsize="5%"  stroke="f" fillcolor="#58f12a"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
    <a href="{{route('verficACCoutn.page',['token'=>$token,'email'=>$email])}} " target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #58f12a; border-radius: 3px;-webkit-border-radius: 3px; -moz-border-radius: 3px; width:64%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
...
<p style="font-size: 14px; line-height: 190%;"><span style="font-size: 16px; line-height: 30.4px;"><strong>Admin</strong></span></p>
<p style="font-size: 14px; line-height: 190%;"><span style="font-size: 16px; line-height: 30.4px;"><strong>BENShop</strong></span></p>
  </div>
