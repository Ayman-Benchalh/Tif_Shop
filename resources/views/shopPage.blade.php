...
@section('content') 
        ...
        <div class="alert alert-danger text-center">
            <strong> Danger ! </strong> you are log Out in your Account , Pleez log In ...
        </div> 
                        ...
                        <div class="col-md-4  ">
                                ...
                                <div class="card mb-4  d-flex product-wap rounded-0">
                                    <div class="card   rounded-0">
                                        <img class="card-img  rounded-0 img-fluid" style="height: 400px ;object-fit: cover"  src="{{  $prod->imageProd  }}">
